...
let UserResolver = class UserResolver {
    ...
    async register(options, { em, req }) {
        ...
        const passhash = await argon2_1.default.hash(options.password);
        const user = em.create(User_1.User, { username: options.username, password: passhash, name: options.name, type: "" });
        try {
